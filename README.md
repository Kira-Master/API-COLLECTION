...
| ZEXXA API | [Kira-Master](https://github.com/Kira-Master) | [link](https://api.zexxa.tech) | `Aktif` | API collection. | `APIKEY` |
| ZEXXA DEV | [ZexxaDevID](https://github.com/ZexxaDevID) | [link](https://web-kira-master.cloud.okteto.net/) | `Aktif` | API collection. | TIDAK |
